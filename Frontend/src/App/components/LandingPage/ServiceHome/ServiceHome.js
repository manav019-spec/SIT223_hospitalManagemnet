                    ...
                    <div className="z-0 w-full bg-white">
                                    ...
                                    <div className="sm:flex sm:flex-row">
                                        ...
                                        <div className="flex flex-col m-2 sm:w-3/5">
                                            ...
                                            <div className="flex items-center py-auto">
                                                ...
                                                <span>Specialty Contact Lenses</span>
                                            </div>
                                            <div className="flex items-center py-auto">
                                                <svg
                                                    className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0"
                                    ...
                                    <div className="sm:flex sm:flex-row">
                                        ...
                                        <div className="flex flex-col m-2 sm:w-3/5">
                                            <div className="flex items-center py-auto">
                                                ...
                                                <span>Ear Syringing | Wax Removal</span>
                                            </div>
                                            <div className="flex items-center py-auto">
                                                <svg
                                                    className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0"
                                            ...
                                            <div className="flex items-center py-auto">
                                                ...
                                                <span>Hearing Assessment | Screening</span>
                                            </div>
                                            <div className="flex items-center py-auto">
                                                <svg
                                                    className="w-4 h-4 mr-1.5 text-green-500 dark:text-green-400 flex-shrink-0"
                                            ...
                                            <div className="flex items-center py-auto">
                                                ...
                                                <span>Snoring | Sleep Apnea Management | Pediatric ENT</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="text-center my-8">
                            ...
                            <button
                                ...
                                className="bg-green-600 text-white rounded-md p-3 px-6 text-lg font-semibold hover:bg-green-700 transition duration-300">
