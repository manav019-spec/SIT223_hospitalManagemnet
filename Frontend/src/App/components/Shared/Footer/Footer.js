  ...
  return (
    <div className="footer-all w-100 p-3">
            ...
            <div className="col-lg-3 col-xs-12 my-2">
                <h2 style={{fontFamily: 'cursive'}}>Mahavir Mediscope Eye Center</h2>
            ...
            <div className="col-lg-3 col-xs-12 my-2">
                <h3>Contact Us</h3>
                <p>mahavir@mediscope.com</p>
                <p>+91 11 1234 5678 / +91 11 1234 5678</p>
            </div>
        </div>
        <div>
            <footer>© Copyright 2023 by Mahavir Mediscope Eye Center</footer>
        </div>
        </div>
  )
}
